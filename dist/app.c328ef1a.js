...
"\n    precision highp float;\n    varying vec3 vNormal;\n    void main() {\n        vec3 normal = normalize(vNormal);\n        float lighting = dot(normal, normalize(vec3(-0.3, 0.8, 0.6)));\n        gl_FragColor.rgb = vec3(0.2, 0.8, 1.0) + lighting * 0.1;\n        gl_FragColor.a = 1.0;\n    }\n";
{
  ...
  var cubeGeometry = new _ogl.Box(gl);
  var cylinderGeometry = new _ogl.Cylinder(gl);
  ...
  var cube = new _ogl.Mesh(gl, {
    geometry: cubeGeometry,
    program: program
  });
  cube.position.set(0, -1.3, 0);
  cube.setParent(scene);
  var cylinder = new _ogl.Mesh(gl, {
...
},{"ogl":"node_modules/ogl/src/index.mjs"}],"C:/Users/Rahul/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Rahul/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
